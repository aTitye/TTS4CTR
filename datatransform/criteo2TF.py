...
parser.add_argument("--dataset", type=Path, default=Path("/data/raw_data/criteo"))
parser.add_argument("--stats", type=Path, default=Path("/data/stats/criteo"))
parser.add_argument("--record", type=Path, default=Path("/data/record/criteo"))
...
if __name__ == "__main__":
    tranformer = CriteoTransform(
        args.dataset, args.record, args.stats, args.threshold, args.label, args.ratio, store_stat=args.store_stat
    )
    tranformer.process()
