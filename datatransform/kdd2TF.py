...
parser.add_argument("--dataset", type=Path, default=Path("data/raw_data/kdd"))
parser.add_argument("--stats", type=Path, default=Path("data/stats/kdd"))
parser.add_argument("--record", type=Path, default=Path("data/record/kdd"))
