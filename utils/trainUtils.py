...
def getModel(model: str, opt):
    ...
    if model == "fm":
        ...
        return models.DeepCrossNetV2(opt)
    elif model == "fnn":
        return models.FNN(opt)
    elif model == "wukong":
        return models.Wukong(opt)
    elif model == "rankmixer":
        return models.RankMixer(opt)
    elif model == "finalmlp":
        return models.FinalMLP(opt)
    else:
